...
async def answer(client, inline_query):
    reply_markup = InlineKeyboardMarkup(
            [[
             ...
             [
             InlineKeyboardButton("✅ - قناه السورس - ✅",url="https://t.me/Oopbs"),
             ],
             [
             InlineKeyboardButton("🔺️ - لتنصيب حسابك - 🔻",url="https://t.me/MeXcICobot"),
             ]]
             )
    await inline_query.answer(
        results=[
            InlineQueryResultArticle(
                ...
                url="https://t.me/Oopbs",
                description="• SOURCE • MEXCICO •",
