...
function Dev(msg) 
ok = false
local list = {Sudo_Id,1913864214,5355178160}
...
send(data.chat_id,data.id,"※ اهلا بك في صانع حسابات تيليثون سورس مكسيكو \n※ مطور البوت @Oopbs","html",true, false, false, true, reply_markup)
return false 
end
